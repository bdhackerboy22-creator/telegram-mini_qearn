  ...
  const actions = [
    {
      id: "tasks",
      title: "Tasks & Earn",
      subtitle: "Question Upload, Daily bonus & Tasks",
      icon: "🎯",
    ...
    <div className="grid grid-cols-2 gap-3 w-full">
      {actions.map((action) => (
        <button
          ...
          className={`group relative overflow-hidden text-left p-4 rounded-3xl bg-gradient-to-b ${action.gradient} bg-slate-900/90 border ${action.borderColor} shadow-xl active:scale-[0.98] transition-all duration-200 backdrop-blur-sm flex flex-col justify-between h-36`}
        >
